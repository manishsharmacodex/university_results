...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['semester_name'])) {
    ...
    $semester_name = strtoupper(trim($_POST['semester_name']));
...
<body>
    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <a href="./list.php" class="<?= $activePage == 'semester' ? 'active' : '' ?>">
        ...
        <div class="main">
            ...
            <div class="breadcrumb">
                ...
                <a href="../dashboard/index.php">Dashboard</a> / Semesters
                        ...
                        <tr>
                            ...
                            <td class="action">
                                ...
                                <a href="#" class="edit" onclick="
                                        document.getElementById('semester_id').value='<?= (int) $row['id'] ?>';
                                        document.getElementById('semester_name').value='<?= htmlspecialchars($row['semester_name'], ENT_QUOTES) ?>';
